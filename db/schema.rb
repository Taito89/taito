...
ActiveRecord::Schema[7.2].define(version: 2025_08_23_090215) do
  ...
  create_table "taito_likes", force: :cascade do |t|
    t.integer "tweet_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tweet_id"], name: "index_taito_likes_on_tweet_id"
    t.index ["user_id"], name: "index_taito_likes_on_user_id"
  end
  ...
  add_foreign_key "taito_likes", "tweets"
  add_foreign_key "taito_likes", "users"
